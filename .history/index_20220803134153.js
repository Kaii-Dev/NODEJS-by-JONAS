...
//ở đây không gây ra hiện tượng blocking vì hàm đọc này được đưa lên xử lý trên cùng => chỉ xử lý 1 lần rồi thôi
...
const server = http.createServer((request, response) => {
  ...
  if (pathName === "/" || pathName === "/overview") {
    ...
    response.writeHead(200, {
      "Content-type": "application/json", //thông báo cho browser biết đang gửi lên yêu cầu 
    });
    response.end(data);
  } else {
